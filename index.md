...
5. Your configuration is now saved, you can connect to the HPC by returning to the Site Manager, selecting the 'HPC' connection, and clicking 'Connect'
...
5. For example, if you wanted to synchronise a directory called jcXXYYYY_AQSYNC on your Desktop, you could first create the folder
...
6.  Create your known_hosts file
